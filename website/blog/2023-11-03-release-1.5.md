...
image: /blog/img/podman-desktop-release-1.5/onboarding-selkies.png
---
...
- **Expanded "Summary" tab for Kubernetes pods**: Go deep with extended details on Kuberentes pods in the pod "Summary" tab
...
We are introducing a new feature providing guided flows for the initial setup of specific 🦭 Podman Desktop extensions. Release 1.5 features two new onboarding flows: Podman, and Compose. Visit **<icon icon="fa-solid fa-cog" size="lg"/>Settings > Resources** in order to start these onboarding flows.
...
We have a discussion board topic where we have posted known issues with this release. If you run into problems, please check this list before filing a bug - if we already have an issue open for it, it saves you the time and truoble of filing, and there may be a workaround posted in the issue.

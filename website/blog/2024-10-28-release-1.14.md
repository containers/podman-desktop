...
- **Kubernetes improvements**: UI changes that will make life with working with kuberneres easier.
- **Port forwarding**: This new feature allows to configure port forwarding in kubernetes environment.

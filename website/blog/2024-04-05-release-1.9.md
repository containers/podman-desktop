...
That said, one issue is that Podman machine version 4 is not compliant at all with a Podman machine version 5.
...
For Podman version 4 users, migrating to Podman version 5 is accessible using an experimental flag.

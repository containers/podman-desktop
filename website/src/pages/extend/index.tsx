      ...
      <section className="text-gray-600 dark:text-gray-400 body-font">
        <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          ...
          <h1 className="title-font sm:text-4xl text-3xl lg:text-6xl mb-4 font-medium text-gray-900 dark:text-white">
            ...
            <p>Podman Desktop is able to use Docker Desktop UI plug-ins by adding a wrapper to intercept the API calls.</p>
            <p>By adding a Docker Desktop extension, you can extend the capabilities of Podman Desktop.</p>

            <ThemedImage className="py-4" alt="Extend with Docker Desktop extensions" sources={{
              light: useBaseUrl('img/extend/extend-dd-light.png'),
              dark: useBaseUrl('img/extend/extend-dd-dark.png'),
            }} />

            <ThemedImage className="py-4" alt="Reuse Docker Desktop extensions" sources={{

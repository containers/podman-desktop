...
Consider rather [installing Podman with OpenShift Local](/docs/onboarding-for-containers/installing-podman-with-openshift-local-on-windows) if your environment doesn't allow you to meet the prerequisites.

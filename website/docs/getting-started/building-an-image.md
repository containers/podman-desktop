...
1. On the **Build Image from Containerfile** screen
   ...
   1. **Image Name**: enter your image name, such as `my_image`. If you want to push the image to a registry, use the fully qualified image name that your registry requires, such as `quay.io/my-repository/my-image`, `ghcr.io/my-repository/my-image`, or `docker.io/my-repository/my-image`.

...
3. **Playgrounds**: Helps in experimenting with model parameters and accuracy to identify the best model for your use case. Each playground denotes a customized environment to experiment with a model.
...
- A user with developer role.

## Installing the extension

1. Go to **extensions > Catalog**.
2. Click the **Install** icon to install the Podman AI Lab extension.
   ![install the extension](img/downloading-ai-lab-ext.png)
3. Select the **Installed** tab to check the extension is active and a new AI Lab component is added in the left navigation pane.
...
3. View the downloaded model on the same page.
...
8. Click the **Close** icon on the right side of the page.
9. View the newly created service on the same page.
   ![new service on the page](img/newly-created-service.png)

10. Optional: View the service container by opening the **Containers** page from the left navigation pane.
...
4. Select the model you want to use with the recipe.
5. Click **Start ChatBot recipe**.
...
3. Enter your question in the chat box and validate the answer.

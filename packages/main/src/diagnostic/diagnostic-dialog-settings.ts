...
export enum DiagnosticSettings {
  SectionName = 'diagnostic',
  DontShowDialog = 'dialog.hideTheDialog',
}

export const diagnosticPreferencesKey = 'preferences.diagnostic';

export class DiagnosticDialogSettings {
  constructor(private configurationRegistry: ConfigurationRegistry) {}

  async init(): Promise<void> {
    const dontShowDialog: IConfigurationNode = {
    ...
    this.configurationRegistry.registerConfigurations([dontShowDialog]);
  }
}

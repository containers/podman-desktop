...
test('Expect basic styling', async () => {
  ...
  expect(element).toHaveClass('text-[var(--pd-input-field-focused-text)]');
  ...
  expect(element).toHaveClass('group-hover-placeholder:text-[var(--pd-input-field-placeholder-text)]');
...
test('Expect basic readonly styling', async () => {
  ...
  expect(element).not.toHaveClass('group-hover-placeholder:text-[var(--pd-input-field-placeholder-text)]');
...
test('Expect basic disabled styling', async () => {
  ...
  expect(element).toHaveClass('outline-0');
  expect(element).toHaveClass('bg-[var(--pd-input-field-bg)]');
  expect(element).toHaveClass('text-[var(--pd-input-field-disabled-text)]');

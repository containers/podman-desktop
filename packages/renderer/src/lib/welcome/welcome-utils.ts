...
import { WelcomeSettings } from '../../../../main/src/plugin/welcome-settings';
import { CONFIGURATION_DEFAULT_SCOPE } from '../../../../main/src/plugin/configuration-registry';

export class WelcomeUtils {
  async getVersion(): Promise<string> {
    return await window.getConfigurationValue<string>(WelcomeSettings.SectionName + '.' + WelcomeSettings.Version);
  }

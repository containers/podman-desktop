...
<a
  ...
  <div
    ...
    class:text-[var(--pd-global-nav-icon)]={!selected || !inSection}
    class:text-[var(--pd-global-nav-icon-selected)]={selected && inSection}
    ...
    class:hover:text-[var(--pd-global-nav-icon-hover)]={!selected || inSection}

  ...
  <NavPage title="Play Pods or Containers from a Kubernetes YAML File" searchEnabled="{false}">
    <div slot="empty" class="bg-zinc-700 p-5 h-full">
      <div class="bg-zinc-800 px-6 py-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8">
        ...
        <div>
          <div class="text-sm font-medium text-gray-300 pb-2">Select Runtime:</div>
            ...
            <div class="flex flex-col space-y-3">
              <div
                ...
                <div class="flex flex-row align-middle items-center">
                  ...
                  <div class="pl-2 text-gray-500">Using a Podman container engine</div>
                </div>
                <div hidden="{runStarted}">
              ...
              <div
                ...
                <div class="flex flex-row align-middle items-center">
                  ...
                  <div class="pl-2 text-gray-500">Using a Kubernetes cluster</div>
                </div>
                ...
                {#if defaultContextName}
                  <div class="pt-2">
                    <label
                      ...
                      class:text-gray-600="{userChoice !== 'kubernetes'}">Kubernetes Context:</label>
                    <input
                      type="text"
                ...
                {#if allNamespaces}
                  <div class="pt-2">
                    <label
                      for="namespaceToUse"
                      class="block mb-1 text-sm font-medium text-gray-300"
                      class:text-gray-600="{userChoice !== 'kubernetes'}">Kubernetes namespace:</label>
                    <select
                      disabled="{userChoice === 'podman'}"
                      class="w-full p-2 outline-none text-sm bg-zinc-900 rounded-sm text-gray-400 placeholder-gray-400"

...
export async function activate(extensionContext: extensionApi.ExtensionContext): Promise<void> {
  ...
  providerOptions.emptyConnectionMarkdownDescription = `The Compose extension provides optional command line support for [compose files](https://compose-spec.io/) with Podman.\n\nMore information: [Podman Desktop Documentation](https://podman-desktop.io/docs/tags/compose)`;
